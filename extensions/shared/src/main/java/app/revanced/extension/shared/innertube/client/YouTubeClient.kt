...
object YouTubeClient {
     ...
     */
    private const val CLIENT_VERSION_ANDROID_NO_SDK = "20.26.46"
    ...
    private const val BUILD_ID_ANDROID_CREATOR = "BD3A.251005.003.W3" // Pixel 10 Pro XL
    ...
    // VISION OS
    private const val CLIENT_VERSION_VISIONOS = "1.03"
    private const val DEVICE_MAKE_VISIONOS = "Apple"
    private const val DEVICE_MODEL_VISIONOS = "RealityDevice17,1"
    private const val OS_NAME_VISIONOS = "visionOS"
    private const val OS_VERSION_VISIONS = "26.5.23O471"
